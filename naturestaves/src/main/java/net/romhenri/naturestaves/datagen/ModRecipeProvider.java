...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, Items.BONE_MEAL, 2)
                ...
                .save(pWriter, NatureStavesMod.MOD_ID + ":calcite_frag_to_bone_meal");
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Blocks.CALCITE)
                ...
                .unlockedBy("has_calcite_frag", has(ModItems.CALCITE_FRAG.get()))
                .save(pWriter, NatureStavesMod.MOD_ID + ":calcite_frag_to_calcite_frag_block");
    ...
    protected static void oreCooking(Consumer<FinishedRecipe> pFinishedRecipeConsumer, RecipeSerializer<? extends AbstractCookingRecipe> pCookingSerializer,
        ...
        for(ItemLike itemlike : pIngredients) {
            SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), pCategory, pResult, pExperience, pCookingTime,
                    ...
                    .save(pFinishedRecipeConsumer, NatureStavesMod.MOD_ID + ":" + getItemName(pResult) + pRecipeName + "_" + getItemName(itemlike));
        }
    }
