package net.romhenri.boostsword;

import com.mojang.logging.LogUtils;
import net.romhenri.boostsword.block.ModBlocks;
import net.romhenri.boostsword.item.ModCreativeModeTabs;
import net.romhenri.boostsword.loot.ModLootModifiers;
...
@Mod(BoostSword.MOD_ID)
public class BoostSword {
    public static final String MOD_ID = "boostsword";
